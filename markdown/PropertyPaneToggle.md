...
##### Signature
PropertyPaneLink(targetProperty: string,
...
##### Signature
PropertyPaneSlider(targetProperty: string,
...
##### Signature
PropertyPaneTextField(targetProperty: string,
...
##### Signature
PropertyPaneToggle(targetProperty: string,
