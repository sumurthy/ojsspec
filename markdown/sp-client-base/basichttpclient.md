...
|:-------------|:----|:-------|:-----------|
|[`fetch(url,options)`](#fetchurloptions)     | `public` | [`Promise`]()<[`Response`](../whatwg-fetch/response.md)> | Performs a REST service call. Although the HttpClient subclass adds  additional enhancements, the parameters and semantics for BasicHttpClient.fetch()  are essentially the same as the WHATWG API standard that is documented here:  https://fetch.spec.whatwg.org/ |
|[`fetchCore(request)`](#fetchcorerequest)     | `protected` | [`Promise`]()<[`Response`](../whatwg-fetch/response.md)> |  |
